...
contract DAOFarmTest is Test {
    ...
    function setUp() public {
        ...
        address farmAddress = factory.createNitroPool(
    ...
    function testDepositBasicFlow() public {
        ...
        assertEq(
            depositToken.balanceOf(address(farm)) - balanceBefore,
            USER_DEPOSIT,
            "Wrong contract balance change"
        );
        assertEq(
            userBalanceBefore - depositToken.balanceOf(user1),
            USER_DEPOSIT,
            "Wrong user balance change"
        );
    }
    ...
    function testEmergencyClose() public {
        ...
        assertEq(
            rewardsToken.balanceOf(emergencyRecoveryAddress),
            remainingAmountBefore,
            "Wrong emergency recovery amount"
        );
    }
    ...
    function testWithdrawWithPendingRewards() public {
        ...
        assertEq(
            rewardsToken.balanceOf(user1) - rewardsBalanceBefore,
            pendingBefore,
    ...
    function testEmergencyWithdrawWithPendingRewards() public {
        ...
        assertEq(
            rewardsToken.balanceOf(user1),
            rewardsBalanceBefore,
            "Should not receive rewards in emergency withdraw"
        );
    }
    ...
    function testSafeRewardsTransfer() public {
        ...
        assertEq(
            rewardsToken.balanceOf(user1),
            pendingRewards / 2,
            "Should receive only available rewards"
        );
    }
